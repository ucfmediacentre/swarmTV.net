<div id="add_video_form_wrapper" class="hidden">
	...
	<form id="add_video_form" class="input_form">
		...
		<!--<div style="padding:10px;"><iframe src="https://swarmtv.net/stream/client/webcamRecorder.html" width="340" height="292" frameborder="0" allowtransparency="true" noresize="noresize" scrolling="no"></iframe></div>-->
