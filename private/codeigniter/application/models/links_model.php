						...
						case "forWeb":
								switch ($link->getKey()) {
										...
										case "right":
												...
												break;
										case "playall":
												$this->shortcodes->replaceShortCode($i, '<div style="text-align:right"><a href=' . base_url() . 'index.php/clip/playAllVideos/' . $page_info->id . '" class="sequenceLink">Play All Videos</a>&nbsp;|&nbsp;</div>');
												break;
										case "shortcode":
