<?php
	...
	$rssfeed .= '<channel>';
	$rssfeed .= '<title>Swarm TV RSS feed</title>';
	$rssfeed .= '<link>http://swarmtv.net/</link>';
	$rssfeed .= '<description>Latest edits on Swarm TV</description>';
	$rssfeed .= '<language>en-us</language>';
	$rssfeed .= '<copyright>Copyright (C) 2013 swarmtv.net</copyright>';
